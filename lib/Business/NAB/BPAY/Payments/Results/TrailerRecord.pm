...
sub to_record ( $self ) {
    ...
    my $record = pack(
        $self->_pack_template(),
        "9",
        sprintf( "%010d", $self->total_number_of_successful_payments ),
        sprintf( "%013d", $self->total_value_of_successful_payments ),
        sprintf( "%010d", $self->total_number_of_declined_payments ),
        sprintf( "%013d", $self->total_value_of_declined_payments ),
